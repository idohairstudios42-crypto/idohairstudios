      ...
      <div className="relative z-10 w-full max-w-md p-6">
        <div className="bg-black/50 backdrop-blur-sm border border-gray-800 rounded-lg p-8">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <a href="https://wa.me/233548947612" className="w-full py-2 bg-green-900 text-white text-center font-['Noto_Serif_Display'] uppercase tracking-wider hover:bg-green-800 rounded">
              Contact on WhatsApp
            </a>
          </div>
        </div>
